...
class InventoryModule(BaseInventoryPlugin, Constructable, Cacheable):
    ...
    def _set_credentials(self, loader):
        ...
        for credential_type in ['cert_file_path', 'cert_password', 'cons3rt_token', 'username']:
        ...
        if not (self.cert_file_path and self.cert_password and self.cons3rt_token) \
                and not (self.username and self.cons3rt_token):
    ...
    def _get_credentials(self):
        ...
        """
        cons3rt_params = {}
        for credential in (('username', self.username),
